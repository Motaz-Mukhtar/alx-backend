    ...
    def get_hyper_index(self, index: int = None, page_size: int = 10) -> Dict:
        ...
        for i in range(page_size):
            try:
                ...
                data.append(self.indexed_dataset()[index + 1])
                index += 1
            index += 1

        return {"index": current_index, "next_index": index,
